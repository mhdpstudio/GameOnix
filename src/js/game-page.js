...
fetch("../../data/json/games-data.json")
    ...
    <div class="game-container">
        ...
        <div class="game-title">
            ...
            <div class="details">
                <div class="game-publisher"> <img src="${
      game.publisherIcon
      ? '../../assets/icons/svg/' + game.publisherIcon
      : `https://cdn.simpleicons.org/${game.ImgPub}/${theme}`
  }" width="40">
  ${game.publisher}</div>
        ...
        <div class="game-layout">
            ...
            <div class="left-column">
                ...
                <div class="main-media">
                    <img id="mainMedia" src="${game.media[0]}">
                </div>
                ...
                <div class="side-panel">
                    ...
                    <div class="commands-btns">
                        <a href="${game.gameLink}" class="download-btn" download rel="noopener noreferrer" target="_blank"><button class="btn"><i class="fa-solid fa-download"></i> Download</button></a>
